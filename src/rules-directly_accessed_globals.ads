----------------------------------------------------------------------
--  Rules.Directly_Accessed_Globals - Package specification         --
--                                                                  --
...
package Rules.Directly_Accessed_Globals is
   ...
   procedure Process_Variable_Declaration (Decl : in Asis.Declaration);

   procedure Post_Process_Package_Body (Element : in Asis.Element);
