...
package body Rules.Unnecessary_Use is
   ...
   begin
      ...
      User_Message ("This rule can be used to check/search use clauses for packages, where");
      User_Message ("no element of the package is referenced in the scope of the use clause.");
   end Help;
   ...
   procedure Process_Use_Clause (Clause : in Asis.Clause) is
      ...
      begin
         ...
         then
            ...
            Good_Name_Elem := Corresponding_Base_Entity
              (Corresponding_Name_Declaration (Good_Name_Elem));
         ...
         declare
            Name_String : constant Wide_String
              := To_Upper (Full_Name_Image (Corresponding_Name_Definition (Good_Name_Elem)));
         ...
         for I in Names'Range loop
            ...
            begin
               ...
               while Used_Packages.Data_Available loop
                  if Used_Packages.Get_Current_Data.Name = Info.Name then
                     Report (Rule_Id,
                             ...
                             & Image (Get_Location (Used_Packages.Get_Current_Data.Elem)));
                  end if;
   ...
   procedure Process_Identifier (Name : in Asis.Name) is
      ...
      begin
         ...
         if Is_Nil (E) then
            -- This should be an implicitely defined operation for which the
            ...
            if Expression_Kind (E) = A_Function_Call then
               declare
         ...
         if Element_Kind (E) = A_Declaration
           and then Declaration_Kind (E) = A_Package_Declaration
         then
      ...
      begin
         ...
         while Used_Packages.Data_Available loop
            declare
               ...
               Info : constant Package_Info := Used_Packages.Get_Current_Data;
            begin
