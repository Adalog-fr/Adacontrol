...
use          Ada.Text_IO, System;                           -- Found: Global Ada.Strings, Check: Global System, OK: Text_IO (exempted)
use     type Ada.Numerics.Complex_Types.Complex;  -- Found: Global type File_type, OK: Complex (exempted)
use all type Ada.Numerics.Complex_Types.Complex; -- Foundx2: Global all type Truncation, Complex
procedure T_use_clauses is
   use Ada.Text_IO;
   use Ada.Text_IO;                                         -- Found: local Ada.Strings
   use Ada.Text_IO, System;                                 -- Found: local Ada.Strings, Error: System
