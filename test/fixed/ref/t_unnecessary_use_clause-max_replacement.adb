...
procedure Max_Replacement is
   ...
   use type T_unnecessary_use_clause.Max_Replacement.Pack3.Int;                    -- Operator: Only used for operators
   V : Pack3.Int;
begin
   declare
      -- Unused: unused
   ...
   declare
                                          -- Primitive: used for primitive operation (on access parameter)
