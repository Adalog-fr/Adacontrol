...
B:
   ...
   while Bool  loop null; end loop;  -- OK
   while True  loop null; end loop;  -- While_True
   while False loop null; end loop;  -- OK
         ...
         begin
            Outer: loop
               ...
               XL1: for I in 1..10 loop            -- untyped for
                  ...
                  while X /= 0 loop                -- Unnamed
                     exit when X = 2;              -- Exit_while_loop
