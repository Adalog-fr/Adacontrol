...
procedure Dimensions is
   ...
   type C3 is array (1 .. 3, Boolean, Integer range -1 .. 1) of Integer;         -- search Dimensions, search First, Index_TTT4
   type C4 is array (1 .. 3, Boolean, Integer range -1 .. 1, 1 .. 3) of Integer; -- check Dimensions, search First

   type U1 is array (Positive range <>) of Integer;                                                          -- Check Last, Index_T6
   type U2 is array (Positive range <>, Boolean range <>) of Integer;                                        -- search Dimensions, check Last
   type U3 is array (Positive range <>, Boolean range <>, Positive range <>) of Integer;                     -- search Dimensions, check Last x2, Index_TTT4
