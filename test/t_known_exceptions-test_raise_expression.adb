...
procedure Test_Raise_Expression is
   ...
   function F2 return Boolean is (True and raise Constraint_Error);  -- Known_Exception
...
begin
   ...
   -- Error cases
   if I = 0 or raise Constraint_Error then                                      -- Known_Exception
      I := 1;
   end if;

   if I = 0 and raise Constraint_Error then                                     -- Known_Exception
      I := 1;
   end if;
   ...
   declare
      procedure P (X : Integer) with Pre => X /= 0 or raise Constraint_Error is -- Known_Exception
      begin
         null;
      end;
   begin
