package X_No_Operator_Usage is
   type X1 is new Integer;                 -- all info, only ops, nolog+noinx
...
private
   type Intermediate1 is range 1 .. 10;    -- all info, only ops, nolog+noinx
   subtype Intermediate2 is Intermediate1 range 3..5;
   type X3 is new intermediate2;           -- all info, only ops, nolog+noinx
